...
```{r}
#| label: load-data
buoy_data<- read_table ("buoy_2024.txt")
print(buoy_data)
...
buoy_data2<- read_table("buoy_2024.txt", 
...
```{r}
#| label: clean-names
buoy_data3<- read_table("buoy_2024.txt", 
                        col_types = cols(.default = "c"), 
                        comment= "#") |>
  clean_names()
print( buoy_data3)
...
write_csv(buoy_data3, "data-raw/buoy_update.csv")
```
...
buoy_cleaned<- read_csv("data-raw/buoy_update.csv", col_types = cols(.default = "c"), na=c("99", "999", "99.0", "99.00"))
print(buoy_cleaned) 
...
>Data from an animal shelter in Long Beach, CA. 
> What animal type is adopted the most?
>What is the most common intake_condition 
